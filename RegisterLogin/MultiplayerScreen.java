...
public class MultiplayerScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(515, 56, 240, 57);
        ...
        createGameBtn.setBackground(new java.awt.Color(179, 11, 11));
        createGameBtn.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        createGameBtn.setForeground(new java.awt.Color(250, 250, 250));
        ...
        getContentPane().add(createGameBtn);
        createGameBtn.setBounds(418, 532, 438, 84);
        ...
        jButton2.setBounds(418, 342, 438, 86);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        JoinGameScreen joinGame = new JoinGameScreen();
        close();
    ...
    private void createGameBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createGameBtnActionPerformed
        // go to waiting screen for making a game
        CreateGameScreen createGame = new CreateGameScreen();
        close();
