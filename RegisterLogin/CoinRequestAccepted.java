 ...
 * @author Karalee
 */
public class CoinRequestAccepted extends javax.swing.JFrame {
    ...
    {
    	jLabel1.setText(userToRequestCoins+" has accepted your coin request of "+coinAmount+" coins");
    	//increment # of coins now
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CoinRequestAccepted().setVisible(true);
            }
        });
    }
